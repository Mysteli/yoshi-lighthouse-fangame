...
' Speed moving vars
Public Const WALK_SPEED As Byte = 7
...
' Website
Public Const GAME_WEBSITE As String = "http://s3.zetaboards.com/Lighthouse_of_Yoshi/index/"
...
' GUI
Public Const MAX_BUTTONS As Long = 41
