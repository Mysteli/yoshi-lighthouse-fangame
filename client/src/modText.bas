...
Sub EngineInitFontTextures()
    ...
    Font_Default.Texture.filepath = App.Path & FONT_PATH & "MLSS.png"
    ...
    Font_Georgia.Texture.filepath = App.Path & FONT_PATH & "MLSS.png"
...
Sub EngineInitFontSettings()
    LoadFontHeader Font_Default, "MLSS.dat"
    LoadFontHeader Font_Georgia, "MLSS.dat"
End Sub
Public Function dx8Colour(ByVal colourNum As Long, ByVal alpha As Long) As Long
    Select Case colourNum
        ...
        Case 2 ' Green
            dx8Colour = D3DColorARGB(alpha, 99, 186, 37)
        Case 3 ' Cyan
        ...
        Case 9 ' BrightBlue
            dx8Colour = D3DColorARGB(alpha, 0, 148, 255)
        Case 10 ' BrightGreen
            dx8Colour = D3DColorARGB(alpha, 126, 240, 137)
        Case 11 ' BrightCyan
            dx8Colour = D3DColorARGB(alpha, 155, 140, 239)
        Case 12 ' BrightRed
        ...
        Case 17 'Orange
            dx8Colour = D3DColorARGB(alpha, 206, 75, 0)
    End Select
End Function
                    ...
                    With Map.Tile(x, y)
                        ...
                        Select Case .Type
                            ...
                            Case TILE_TYPE_NPCSPAWN
                                RenderText Font_Default, "S", tx, ty, BrightRed, 0
                            Case TILE_TYPE_SHOP
