            ...
            For i = 1 To Player_HighIndex
                If IsPlaying(i) Then
                    ...
                    If TempPlayer(i).stopRegen Then
                        If TempPlayer(i).stopRegenTimer + 0 < GetTickCount Then
...
Private Sub UpdateMapLogic()
        ...
        If PlayersOnMap(mapnum) = YES Then
            ...
            For x = 1 To MAX_MAP_NPCS
                ...
                'If Not MapNpc(mapnum).Npc(x).stopRegen Then
                    'If MapNpc(mapnum).Npc(x).Num > 0 And TickCount > GiveNPCHPTimer + 1 Then
    ...
    If GetTickCount > GiveNPCHPTimer + 15000 Then
